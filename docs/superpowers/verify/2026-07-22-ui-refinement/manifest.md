...
## Pending — OPERATOR / browser-gated (cannot run headless; per plan T-5.2 + operator ship instruction)

The visual matrix and live-deploy verification require a real browser + the live `:8443` deploy. Deferred to the operator's ship-phase check:
