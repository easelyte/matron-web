...
// PDF preview via the app's EXISTING pdf.js → <canvas> primitive. pdf.js parses in a worker and
    ...
    useEffect(() => {
        ...
        void (async () => {
            try {
                ...
                // friendly message (never leak the engine's internal error text to the user).
