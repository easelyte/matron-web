...
function ConversationList({
    ...
    const newSessionMoreRef = useRef<HTMLButtonElement>(null);
    // The agent roster behind one-tap start: which box it runs on, and "No box connected".
    const [newSessionBoxes, setNewSessionBoxes] = useState<DeviceDTO[]>();
    useEffect(() => {
            ...
            <div className="mx_LeftPanel_wrapper mx_LeftPanel_newRoomList">
                    ...
                    <div className="mx_LeftPanel mx_LeftPanel_newRoomList">
                        <div className="mx_LeftPanel_roomListContainer">
                            <nav className="mx_RoomListPanel" aria-label="Room list">
                                ...
                                {/* v6 sidebar.newSession: one-tap split button (defaults) + ⋯ options. */}
                                <NewSessionSplit
                                    client={client}
                                    boxes={newSessionBoxes}
                                    moreRef={newSessionMoreRef}
                                    onOpenSheet={() => {
                                        setAccountOpen(false);
                                        closeRoomMenu();
                ...
                {roomMenu && menuConversation && (
                    ...
                    >
                        ...
                        {/* #541: manual collapse/expand of this conversation's subagent child
                            rows — shown ONLY when it currently hosts child rows (hasSubagentChildRows
